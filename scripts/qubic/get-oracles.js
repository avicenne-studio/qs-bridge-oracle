/**
 * QSB GetOracles — list all oracle accounts registered on the contract.
 *
 * Usage:
...
const buf = await queryContractFunction(bobUrl, QSB_CONTRACT_INDEX, FUNC_GET_ORACLES, new Uint8Array(0));

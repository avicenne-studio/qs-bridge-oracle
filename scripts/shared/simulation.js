...
const baseEnv = {
  ...
  RELAYER_FEE_TO_SOLANA: "1",
  RELAYER_FEE_TO_QUBIC: "1",
...
function startOracle(oracle) {
  ...
  const solanaKeysFile = `./.temp/${oracle.id}.keys.json`;
  const qubicKeysFile = `./.temp/${oracle.id}.qubic.keys.json`;

...
- **`scripts.js`**: Generates JavaScript/TypeScript client code in `clients/js/`
...
**Important**: The generated code in `clients/js/` is **AUTOGENERATED**. Do not edit it directly. If you need changes, modify the IDL or the `before` script, then regenerate.
...
**What you need**: The generated code in `clients/js/` directory, which should already be committed to the repository.
...
```typescript
import { findOutboundOrderPda } from './clients/js/pdas/outboundOrder';
...
```typescript
import { findInboundOrderPda } from './clients/js/pdas/inboundOrder';
...
```typescript
import { fetchGlobalState } from './clients/js/accounts/globalState';
...
```typescript
import { fetchOracle } from './clients/js/accounts/oracle';
...
```typescript
import { fetchOutboundOrder } from './clients/js/accounts/outboundOrder';
...
```typescript
import { fetchInboundOrder } from './clients/js/accounts/inboundOrder';
...
```typescript
import { getOutboundEventDecoder } from './clients/js/types/outboundEvent';
...
```typescript
import { getOverrideOutboundEventDecoder } from './clients/js/types/overrideOutboundEvent';
...
```typescript
import { getInboundEventDecoder } from './clients/js/types/inboundEvent';
...
- [ ] **Verify client code is up-to-date**
  - Check if `clients/js/` files have been regenerated after contract changes
...
### Must Understand
- `clients/js/accounts/outboundOrder.ts` - Outbound order account structure
- `clients/js/accounts/inboundOrder.ts` - Inbound order account structure
- `clients/js/accounts/oracle.ts` - Oracle account structure
- `clients/js/accounts/globalState.ts` - Global state (includes pause status, oracle count)
- `clients/js/types/outboundEvent.ts` - Outbound event structure
- `clients/js/types/overrideOutboundEvent.ts` - Override outbound event structure
- `clients/js/types/inboundEvent.ts` - Inbound event structure
- `clients/js/pdas/` - PDA derivation helpers
...
3. Check generated client code comments in `clients/js/`
